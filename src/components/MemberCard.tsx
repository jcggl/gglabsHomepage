...
export default function MemberCard({image, name, role, comment, contect}: any) {
  return (
    <div className={String.raw`w-[clamp(320px,41.6vw,378px)] flex flex-col justify-evenly items-center mb-[clamp(32px,3.25vw,52px)] mx-4 px-[clamp(10px,1.8vw,20px)]`}>
      <div className={String.raw`w-[55%] flex flex-col items-center`}>
        ...
        <h6 className={String.raw`text-white text-[clamp(12px,1.56vw,16px)] mb-[clamp(10px,1.3vw,16px)]`}>
          {role}
        </h6>
      </div>
      <h5 className={String.raw`text-white text-[clamp(16px,2.08vw,28px)] font-bold leading-[36px] mb-[clamp(4px,0.5vw,6px)]`}>{name}</h5>
